package supwisodom.util;

import java.nio.charset.Charset;

public interface Constants {
	// CAS根地址
	String CAS_BASE_PATH = "http://localhost:8080/cas/";

	// 业务系统需要显式使用的端口配置，包括80端口，如果不需要配置显式端口，则配置空字符串""即可
	String CLIENT_SYSTEM_EXPLICIT_PORT = "8088";
	...
	//登录成功默认跳转地址
	String DEF_TARGET_URI = "index/welcom";

	// 业务系统认证集成改造之后的登录URI
	String SSO_LOGIN_URI = "sso/login";

	// 业务系统认证集成失败提示页
	String SSO_ERROR_URI = "/error";
